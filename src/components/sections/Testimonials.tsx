        ...
        <div className="mt-16 flex flex-col gap-16">
          ...
          <div className="mx-auto max-w-4xl w-full">
             <TiltSurface maxTilt={5}>
               <div className="relative w-full aspect-[21/9] sm:aspect-[3/1] rounded-[40px] p-1 bg-gradient-to-r from-transparent via-indigo-500/30 to-transparent flex items-center justify-center">
                 <div className="absolute inset-0 bg-cyan-500/10 rounded-[40px] blur-[20px] -z-10" />
                 
                 <div className="relative h-full w-full overflow-hidden rounded-[36px] bg-[#0A0F1C] border border-white/10 flex items-center justify-between p-8">
                   ...
                   <div className="relative z-10 w-1/2">
                      ...
                      <h3 className="text-xl sm:text-2xl font-bold text-white leading-snug drop-shadow-lg">Active Enterprise Nodes</h3>
                      <p className="text-cyan-200 text-sm mt-2">Connecting global teams instantly.</p>
                   </div>

                   <div className="relative z-10 w-1/2 h-full flex justify-end items-end">
                     <div className="relative w-64 h-64 overflow-visible">
                       <Image 
                         ...
                         alt="Global Network"
                         fill
                         className="object-contain scale-150 origin-bottom right-0 drop-shadow-[0_0_30px_rgba(0,255,255,0.3)] float-slow"
                       />
                     </div>
                   </div>
                 </div>
              ...
              {marqueeItems.map((t, idx) => (
                <div key={`${t.quote}-${idx}`} className="w-[380px] shrink-0">
                  <div className="group relative h-full">
                    ...
                    <Card className="relative h-full min-h-[250px] p-6 bg-[#0A0F1C]/80 backdrop-blur-2xl border border-white/10 shadow-[0_20px_50px_-15px_rgba(0,0,0,0.5)] transition-all duration-500 hover:border-cyan-400/30 overflow-visible flex flex-col justify-between" style={{ transformStyle: 'preserve-3d' }}>
                      ...
                      <div>
                        ...
                        <blockquote className="mt-4 text-sm leading-relaxed text-slate-300 font-medium">
                          {t.quote}
                        </blockquote>
                      </div>
                      
                      <figcaption className="mt-6 flex items-center gap-4 border-t border-white/5 pt-4">
